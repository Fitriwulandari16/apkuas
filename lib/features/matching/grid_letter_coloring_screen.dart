...
class _GridLetterColoringScreenState extends ConsumerState<GridLetterColoringScreen> {
  ...
  void _onLevelComplete() async {
    ...
    try {
      await UserService.updateProgress(39);
    } catch (e) {
      debugPrint('Cloud progress update failed for level 39: $e');
    }

    if (!mounted) return;

    // 3. Show premium success dialog
    _showSuccessDialog();
  }
              ...
              child: Material(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Hebat! Kamu sudah bisa mengelompokkan huruf dengan sangat baik!',
                      style: GoogleFonts.fredoka(
                        fontSize: 18,
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pop(context); // close level 39 screen
                      },
                      child: Text(
                        'SELESAI',
                        style: GoogleFonts.fredoka(
