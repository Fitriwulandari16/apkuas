...
/// Level 38 — Tangled Lines Matching.
class TangledLinesMazeLevelScreen extends ConsumerStatefulWidget {
  final int levelId;
  const TangledLinesMazeLevelScreen({super.key, this.levelId = 38});
          ...
          builder: (context, constraints) {
            ...
            return Stack(
              children: [
                Positioned.fill(
                  child: CustomPaint(
                    painter: TangledLinesPainterL38(nodes: nodePositions),
                  ),
                ),
...
class TangledLinesPainterL38 extends CustomPainter {
  final Map<String, Offset> nodes;
  TangledLinesPainterL38({required this.nodes});
