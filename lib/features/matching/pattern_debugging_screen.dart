...
class _PatternDebuggingScreenState extends ConsumerState<PatternDebuggingScreen> {
  ...
  void _onLevelComplete() async {
    ...
    try {
      await UserService.updateProgress(44);
    } catch (e) {
      debugPrint('Cloud progress update failed for level 44: $e');
    }
              ...
              child: Material(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Hebat! Kamu sudah berhasil memperbaiki eror pada semua pola!',
                      style: GoogleFonts.fredoka(
                        fontSize: 18,
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pop(context); // close level 44 screen
                      },
                      child: Text(
                        'SELESAI',
                        style: GoogleFonts.fredoka(
